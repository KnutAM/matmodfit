...
stress_old = stress
call elastic(mpar, statev, dstran, stress_old, stress, ddsdde, yielding)
...
if (yielding) then
    ...
    call setup(x0, xold, param, stress_old, stress, statev, dtime)
    ...
    call plastic_output(ddsdde, statev, stress, x0, jac_inv, mpar, stress_old, stran, dstran)
